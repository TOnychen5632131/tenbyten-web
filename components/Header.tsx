...
const Header = () => {
    return (
        <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-4 md:p-6">
            {/* Google G Logo - Left */}
            <div className="flex items-center justify-center p-2 rounded-full bg-[#1F1F1F] hover:bg-[#303030] transition-colors cursor-pointer w-10 h-10 md:w-12 md:h-12">
            ...
            <div className="absolute left-16 md:left-20 flex flex-col justify-center">
                <span className="text-gray-400 text-sm md:text-base font-medium">Good evening,</span>
                <span className="text-gray-500 text-xs md:text-sm">Roman</span>
            </div>
