...
import { Plus, Store, ShoppingBag, LogOut, Upload, FileJson } from 'lucide-react';
        ...
        <div className="min-h-screen bg-black text-white p-4 md:p-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex gap-4 mb-6 overflow-x-auto pb-2 md:pb-0">
                    ...
                    >
                        <Store size={24} />
                        <span className="font-bold tracking-wide text-xs md:text-sm">ADD MARKET</span>
                    </button>
                    <button
                    ...
                    >
                        <ShoppingBag size={24} />
                        <span className="font-bold tracking-wide text-xs md:text-sm">ADD SHOP</span>
                    </button>
                    <button
                    ...
                    >
                        <Upload size={24} />
                        <span className="font-bold tracking-wide text-xs md:text-sm">JSON IMPORT</span>
                    </button>
                </div>
                ...
                <div className="bg-[#111] border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
                    <div className={`absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none transition-colors duration-500
                        ${activeTab === TABS.MARKET ? 'bg-blue-500/10' :
                            activeTab === TABS.CONSIGNMENT ? 'bg-emerald-500/10' : 'bg-violet-500/10'}`}
                    />
